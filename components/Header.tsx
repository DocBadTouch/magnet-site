...
const DiscordIconLink = () => (
  <li>
    <a href="https://discord.com/magnetdao" className="anchor" target="_blank" rel="noreferrer" title="Discord">
...
const TwitterIconLink = () => (
  <li>
    <a href="https://twitter.com/magnet_dao" className="anchor" target="_blank" rel="noreferrer" title="Twitter">
      <svg width="50" height="50" xmlns="http://www.w3.org/2000/svg">
